...
class BookmarkController extends AbstractController
{
    ...
    public function getBookmarkList(): JsonResponse
    {
        ...
        $jsonBookmarkList = $this->serializer->serialize($bookmarkList, 'json', [
            'groups' => 'getBookmarks',
        ]);
